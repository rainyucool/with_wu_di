...
public class testItemPairMapper extends MapperBase {
	...
	public void map(long recordNum, Record record, TaskContext context) throws IOException {
		...
		String dest_item_info = Long.toString(dest_item_id) + ":" + Long.toString(dest_cat_id);
		key_item_id.set(new Object[]{dest_item_info});
		val_item_info.set(new Object[]{dest_item_title});
